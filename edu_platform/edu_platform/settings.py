...
SECRET_KEY = "django-insecure-_1n!7yt$nnjh(co+%$8_0#9gthh)v!o(o!j+3c-@h45u2_9ga_"
...
# Define the URL to redirect for login
LOGIN_URL = '/login/'

# OR dynamically redirect to different dashboards
